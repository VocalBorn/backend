...
from src.practice.routers.progress_router import router as practice_progress_router
...
from src.chat.websocket import ws_router
...
app.include_router(practice_progress_router)
